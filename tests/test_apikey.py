...
#        pass
    ...
    def setUpClass(self):
        ...
        self.point_query_url = reverse('layers-list', kwargs={'apikey': apikey}) + 'point_query/'
        self.spatial_query_url = reverse('das-list', kwargs={'apikey': apikey}) + 'spatial_query/'
        self.sqs_layer_query_url = reverse('layers-list', kwargs={'apikey': apikey}) #+ '50/layer.json/'
        ...
        self.spatial_query_url2 = reverse('das-list', kwargs={'apikey': apikey2}) + 'spatial_query/'
    ...
    def test_das_request_single_incorrect_apikey_url(self):
        ...
        spatial_query_url = reverse('das-list', kwargs={'apikey': '1234'}) + 'spatial_query/'
    ...
    def test_das_request_single_unknown_ip_address_url(self):
        ...
        self.assertEqual(response.data['message'], 'Access Forbidden')
