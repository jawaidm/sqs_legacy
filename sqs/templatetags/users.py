...
#from sqs import helpers
from django.conf import settings
from sqs import helpers as sqs_helpers
#from sqs.components.main.models import SystemMaintenance
...
def is_model_backend(context):
    ...
    request = context['request']
    return sqs_helpers.is_model_backend(request)
